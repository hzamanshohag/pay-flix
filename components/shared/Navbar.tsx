...
const Navbar = () => {
  ...
  return (
    <nav className="relative top-0  z-10 flex items-center justify-between w-full mx-auto py-[15px] px-4 sm:px-8 lg:px-20 max-w-7xl bg-white">
      {/* logo */}
      <img
      ...
      <ul className="items-center gap-[20px] text-[1rem] text-[#424242] md:flex hidden">
        <li className="flex items-center dark:text-[#abc2d3] hover:text-[#3B9DF8] group gap-[5px] cursor-pointer">
          <IoIosArrowUp className="text-[1.1rem] group-hover:text-[#3B9DF8] dark:text-[#abc2d3] text-gray-600" />
          Features
        </li>
